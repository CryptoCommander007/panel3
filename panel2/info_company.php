                ...
                <div class="bg-light rounded p-4">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="apellido" class="form-label">Rubro:</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="email" class="form-label">Correo Electrónico Empresa:</label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <label for="celular" class="form-label">Número Teléfonico Empresa:</label>
                                <div class="input-group">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="descripcion_empresa" class="form-label">Descripción Empresa</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-building"></i></span>
                                    <textarea class="form-control" id="descripcion_empresa" placeholder="Escribe aquí la descripción de la empresa" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="productos_ofrecidos" placeholder="Describe aquí los productos ofrecidos" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="servicios_ofrecidos" placeholder="Describe aquí los servicios ofrecidos" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
