...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="home.php" class="nav-item nav-link active" style="font-size: 1.2rem;">
                        <i class="fas fa-home me-2"></i>Inicio
                    </a>
                    <a href="profile.php" class="nav-item nav-link" style="font-size: 1.2rem;">
                        <i class="fas fa-user me-2"></i>Perfil
                    </a>
                    <a href="services.php" class="nav-item nav-link" style="font-size: 1.2rem;">
        ...
        <div class="content">
            ...
            <?php require 'components/saldo.php'; ?>
            <?php require 'components/home_info_cards3.php'; ?>
            <?php require 'components/home_info_cards.php'; ?>
            <?php require 'components/home_info_cards2.php'; ?>
            <?php require 'components/profile_info_client.php'; ?>
            <?php require 'components/request_create_request.php'; ?>
            <?php require 'components/courses_info_courses.php'; ?>
            <?php require 'components/modal.php'; ?>
            <?php require 'components/modal_confirmation.php'; ?>
