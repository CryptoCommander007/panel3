<?php
// Cargar las categorías y subcategorías junto con los últimos hilos y respuestas
require 'get_category_forum.php';
?>
                                ...
                                <table class="table table-striped table-hover align-middle">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="text-center">Temas</th>  <!-- Nueva columna para cantidad de temas -->
                                            <th class="text-center">Respuestas</th> <!-- Nueva columna para cantidad de respuestas -->
                                            <th class="text-center">Último Mensaje</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <!-- Mostrando categorías y subcategorías -->
                                        <?php foreach ($categories as $category => $subcategories): ?>
                                            ...
                                            <?php foreach ($subcategories as $subcategory): ?>
                                                <tr>
                                                    ...
                                                    <td class="table-text text-center">
                                                        <strong><?php echo $subcategory['thread_count']; ?></strong>  <!-- Mostrar contador de temas -->
                                                    </td>
                                                    <td class="table-text text-center">
                                                        <strong><?php echo $subcategory['answer_count']; ?></strong>  <!-- Mostrar contador de respuestas -->
                                                    </td>
                                                    <td class="table-text text-center">
                                            ...
                                            <?php foreach ($subcategories as $subcategory): ?>
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="small">Temas: <?php echo $subcategory['thread_count']; ?></p>  <!-- Mostrar contador de temas en pantallas pequeñas -->
                                                        <p class="small">Respuestas: <?php echo $subcategory['answer_count']; ?></p>  <!-- Mostrar contador de respuestas en pantallas pequeñas -->
                                                        <?php if ($subcategory['last_post_title'] && $subcategory['last_post_user']): ?>
